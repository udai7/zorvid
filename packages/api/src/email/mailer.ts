...
const from = process.env.SMTP_FROM ?? (user ? `Zorvid <${user}>` : "Zorvid");
...
export async function sendOtpEmail(to: string, code: string): Promise<void> {
  ...
  await transport.sendMail({
    from,
    to,
    subject: `Your Zorvid verification code: ${code}`,
    text: `Your Zorvid verification code is ${code}. It expires in 10 minutes. If you didn't request this, you can ignore this email.`,
    html: `
      <div style="font-family:system-ui,sans-serif;max-width:420px;margin:auto">
        <h2 style="font-weight:600">Verify your Zorvid sign-in</h2>
