...
/** Shared shell for the auth screens (centered card with brand + back link). */
export function AuthShell({ children }: { children: React.ReactNode }) {
  return <div className="grid min-h-screen place-items-center bg-subtle px-6 py-10">{children}</div>;
}
